    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold text-primary m-2">
                <font color="#0A2342">Form Tambah Penyakit</font>
            </h5>
        </div>
        <div class="card-body">
            <form method="post" action="<?= base_url('admin/master_penyakit/simpan') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kode_penyakit_display" value="<?= $newKodePenyakit ?? '' ?>" readonly>
                    <input type="hidden" name="kode_penyakit" value="<?= $newKodePenyakit ?? '' ?>">
                </div>
                <div class="form-group">
