    ...
    public function delete($id_faq)
    {
        ...
        if ($this->request->isAJAX()) {
            return $this->response->setJSON([
                'success' => true,
                'message' => 'Data FAQ berhasil dipindahkan ke Recycle Bin.'
            ]);
        }

        return redirect()->to(base_url('/admin/master_faq'))->with('success', 'Data FAQ berhasil dipindahkan ke Recycle Bin.');
    }
